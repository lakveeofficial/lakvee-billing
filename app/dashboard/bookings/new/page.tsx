...
const __DEPRECATED__ = `
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Shipment Type</label>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="flex flex-col">
            ...
            {!canOverrideRate && <span className="text-[11px] text-gray-500">Auto-filled from slab. No override permission.</span>}
          </div>
        </div>
      </div>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Chargeable Weight (Kg)</label>
          ...
          <div className="flex flex-col">
            ...
            <input className="border rounded px-2 py-1 bg-gray-50" value={retailPrice.toFixed(2)} readOnly />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Shipping Charges</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Packaging Charges</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Risk Type</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Risk Value</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Employee Discount %</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Employee Discount Amount</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Promo Discount Amount</label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Final Collected Amount</label>
            <input className="border rounded px-2 py-1 bg-gray-50" value={finalAmount.toFixed(2)} readOnly />
          </div>
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Prepaid Amount</label>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Recipient Phone</label>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Mode of Booking</label>
          ...
          <div className="md:col-span-2 flex flex-col">
            <label className="text-xs text-gray-600">Contents</label>
            <textarea className="border rounded px-2 py-1" value={form.contents} onChange={(e)=>setForm(f=>({...f, contents: e.target.value}))} />
          </div>
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Declared Value</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">E-Way Bill</label>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Payment UTR (if applicable)</label>
      ...
      <div className="border rounded p-3 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Employee Code</label>
            <input className="border rounded px-2 py-1" value={form.employeeCode} onChange={(e)=>setForm(f=>({...f, employeeCode: e.target.value}))} />
          </div>
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">Packing Material Used</label>
          ...
          <div className="flex flex-col">
            <label className="text-xs text-gray-600">No. of Stretch Films Used</label>
