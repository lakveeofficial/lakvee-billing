  ...
  if (!company) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-slate-900 mb-2">Company not found</h3>
          ...
          <div className="bg-white p-6 rounded-xl border">
            <div className="text-center">
              {company.logo ? (
                ...
                <div className="w-32 h-32 mx-auto rounded-xl bg-gray-200 flex items-center justify-center mb-4">
                  <Building2 className="w-16 h-16 text-slate-400" />
                </div>
              )}
              <h3 className="text-lg font-semibold text-slate-900 mb-2">{company.businessName}</h3>
            ...
            {company.signature && (
              <div className="mt-6 pt-6 border-t">
                <h4 className="text-sm font-medium text-slate-700 mb-3">Digital Signature</h4>
                <div className="text-center">
                  <img
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">{company.phoneNumber}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">{company.emailId}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-slate-900">{company.gstin || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white p-6 rounded-xl border">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium text-slate-900">{businessType?.label || company.businessType}</p>
              </div>
              <div>
                <p className="text-sm text-slate-600">Business Category</p>
                <p className="font-medium text-slate-900">{businessCategory?.label || company.businessCategory}</p>
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-xl border">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-slate-900">{company.businessAddress}</p>
                <p className="text-sm text-slate-600 mt-1">{company.state} - {company.pincode}</p>
              </div>
            </div>
          </div>
        </div>
